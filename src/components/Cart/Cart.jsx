...
import { AddProductToCart, RemoveProductFromCart, AddProductToSaved } from '../../redux/actions/index'
...
export const Cart = () => {
  ...
  return (
    <CartView cart={cart} total={total} addQty={addQty} RemoveProduct={RemoveProduct} addSaved={addSaved} />
  )
}
